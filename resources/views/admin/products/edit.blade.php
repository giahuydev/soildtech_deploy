...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <!-- Form thêm biến thể -->
            <form action="{{ route('admin.product_variants.store', $product->id) }}" method="POST" class="mb-4 p-3 bg-light border rounded">
                @csrf
                    ...
                    <tbody>
                        @forelse($product->variants as $variant)
                            <tr>
                                ...
                                <td class="align-middle">
                                    <form action="{{ route('admin.product_variants.destroy', $variant->id) }}" method="POST" class="d-inline" data-confirm-text="Xóa biến thể này?">
                                        @csrf
